...
function SignIn (props)  {
  ...
  var handleSubmitSignIn = async () => {
    const data = await fetch("172.16.190.134:3000/sign-in", {
      method: "POST",
  ...
  return (
    ...
    >
      ...
      <Text style={{fontWeight:'200', fontSize: 14}}>Login and engage with our community!</Text>
      </View>
      ...
      />
    <Text style={{ marginTop:5,marginLeft: 100, fontWeight:"100", fontSize: 12 } } onPress={() => props.navigation.navigate("ForgetPassword")}>Forgot password? </Text>
